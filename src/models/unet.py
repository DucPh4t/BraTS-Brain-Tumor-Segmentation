"""
Mô tả: Kiến trúc mô hình U-Net 2D Baseline (Exp001 - Exp008). Mô hình mạng nơ-ron tích chập đối xứng cổ điển để phân đoạn ảnh y tế 2D.
Đầu vào:
...
class UNet2D(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.outc(x)  # Trả về raw logits. Sigmoid được áp dụng ở bên ngoài (trainer/evaluator).
